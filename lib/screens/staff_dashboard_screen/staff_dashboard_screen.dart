...
class StaffDashBoardScreenClass extends State<StaffDashBoardScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final formatterTitle = GlobalConstants.dateFormatViewed;
    String formattedDateTitle = formatterTitle.format(DateTime.now());

    final formatterServer = GlobalConstants.dateFormatServerDashBoard;
    String formattedDateServer = formatterServer.format(DateTime.now());
                                  ...
                                  children: [
                                    Column(children: [
                                      Text(
                                        ...
                                        getAllAttendanceHolding(state.companyStaffDashBoardList).toString() : "----",
                                    ...
                                    Column(children: [
                                      Text(
                                        state.companyStaffDashBoardEnumStates == CompanyStaffDashBoardEnumStates.success ?
                                        getAllAbsentHolding(state.companyStaffDashBoardList).toString() : "----",
                                        style: const TextStyle(
                                            color: Colors.white),),
                                      whiteText("Absents"),
                                    ],),
                                    Column(children: [
                                      Text(
                                        state.companyStaffDashBoardEnumStates == CompanyStaffDashBoardEnumStates.success ?
                                        getAllContrator(state.companyStaffDashBoardList).toString() : "----",
                                        style: const TextStyle(
                                            color: Colors.white),),
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Center(
                                      child: Text(
                                        state.companyStaffDashBoardEnumStates == CompanyStaffDashBoardEnumStates.success ?
                                        getAllManPower(state.companyStaffDashBoardList).toString() : "----",
                                      ...
                                      children: [
                                        ...
                                        Column(children: [
                                          Padding(
                                            ...
                                            child: Text(
                                              state.companyStaffDashBoardEnumStates == CompanyStaffDashBoardEnumStates.success ?
                                              getTotalStaff(state.companyStaffDashBoardList).toString() : "----",
                                          ...
                                          Padding(
                                            padding: const EdgeInsets.all(8.0),
                                            child: state.companyStaffDashBoardEnumStates == CompanyStaffDashBoardEnumStates.success ?
                                            getAttendancePercentage(getAllAttendanceStaff(state.companyStaffDashBoardList) +
                                                    0.0, getTotalStaff(state.companyStaffDashBoardList) + 0.0) :
                                        ...
                                        Column(
                                          ...
                                          children: [
                                            ...
                                            Padding(
                                              ...
                                              child: Text(
                                                state.companyStaffDashBoardEnumStates == CompanyStaffDashBoardEnumStates.success ?
                                                getTotalLabor(state.companyStaffDashBoardList).toString() : "----",
                                                style: TextStyle(
                                                    color: Colors.white),),
                                            ),
                                             Padding(
                                            ...
                                            Padding(
                                              padding: const EdgeInsets.all(
                                                  8.0),
                                              child: state.companyStaffDashBoardEnumStates == CompanyStaffDashBoardEnumStates.success ?
                                              getAttendancePercentage(getAllAttendanceLabor(state.companyStaffDashBoardList) +
                                                  0.0, getTotalLabor(state.companyStaffDashBoardList) + 0.0) :
                                              getAttendancePercentage(1.0, 1.0),),
                                          ],),
                                      ],
                                    ),
