...
class StaffDashboardJobScreen extends StatefulWidget{
  ...
  @override
  State<StaffDashboardJobScreen> createState() => StaffDashboardJobScreenClass();
}
                    ...
                    body: BlocProvider.value(
                        value: StaffDashboardJobCubit.get(context)
                          ..getFirstStaffBoardJobs(
                              currentRequestData[StaffDashboardJobScreen
                                  .projectCode],
                              currentRequestData[StaffDashboardJobScreen
                                  .director],
                              currentRequestData[StaffDashboardJobScreen
                        ...
                        child: BlocConsumer<StaffDashboardJobCubit,
                          ...
                          builder: (context, state) {
                            return Padding(
                              ...
                              child: state.jobStaffDashBoardEnumStates ==
                                  JobStaffDashBoardEnumStates.success
