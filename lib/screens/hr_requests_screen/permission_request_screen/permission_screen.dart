            ...
            child: BlocBuilder<PermissionCubit,PermissionInitial>(
                builder: (context,state) {
                  return Scaffold(
                    ...
                    appBar: AppBar(title: const Text('Permission Request'),backgroundColor: Colors.transparent,elevation: 0,),
                    floatingActionButton: Column(
                      ...
                      children: <Widget>[
                        if(state
                            ...
                            TakeActionStatus.takeAction)FloatingActionButton.extended(
                          heroTag: null,
                          onPressed: () {},
                            ...
                            Navigator.of(context).pushReplacement(
                                MaterialPageRoute(builder: (_) =>
                                    SuccessScreen(text: state.successMessage ??
                                        "Error Number",routName: PermissionScreen.routeName, requestName: 'Permission',)));
                          }
