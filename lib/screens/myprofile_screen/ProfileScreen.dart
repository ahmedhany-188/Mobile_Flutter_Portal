  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        body: BlocProvider<ProfileManagerCubit>(
            create: (context) => ProfileManagerCubit(),
            child: BlocConsumer<ProfileManagerCubit, ProfileManagerState>(
                listener: (context, state) {
                  if (state is BlocGetManagerDataSuccessState) {
                    ...
                    // print("")
                    // Navigator.of(context).pushNamed(DirectMan
                    // agerProfileScreen.routeName,arguments:
                    // {DirectManagerProfileScreen.employeeDataKey: state.managerData.toString()});
                                  ...
                                  children: [
                                    ...
                                    Container(
                                      ...
                                      child: RoundedLoadingButton(
                                        ...
                                        onPressed: () {
                                          BlocProvider.of<ProfileManagerCubit>(
                                              context)
                                              .getManagerData(
