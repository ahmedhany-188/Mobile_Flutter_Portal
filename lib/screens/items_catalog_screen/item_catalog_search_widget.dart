  ...
  return  BlocBuilder<ItemCatalogSearchCubit, ItemCatalogSearchState>(
      builder: (context, state) {
        ...
        if (state.searchString != "" && state.detail == false) {
          return WillPopScope(
            onWillPop: () async{
              int treeLenght=ItemCatalogSearchCubit.get(context).getTreeLenght();
              if(treeLenght==1){
                return true;
              }else{
                treeLenght--;
                    ...
                    child: ListView.builder(
                      ...
                      itemBuilder: (context,index){
                        ...
                        child: InkWell(
                          ...
                          style: const TextStyle(fontSize: 15,color: ConstantsColors.bottomSheetBackground,fontStyle: FontStyle.italic),),
                          ),
                        );
                      }),
                  ),
