  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton.extended(
        onPressed: () =>
            importDataCart(ItemCatalogSearchCubit
                .get(context)
                .state
                .cartResult, () {
            ...
            if (state.detail == false) {
              return Column(
                children: [
                  ...
                  Expanded(
                    child: state.cartResult.isNotEmpty ? ListView.builder(
                      shrinkWrap: true,
                            ...
                            onTap: () {
                              ItemCategorygetAllData itemCategorygetAllData = ItemCategorygetAllData(
                                  ...
                                  itemDesc: state.cartResult[index].itmCatItems
                                      ?.itemDesc,
                                  itemID: state.cartResult[index].itmCatItems
                                      ?.itemID,
                                  itemQty: state.cartResult[index].itmCatItems
                                      ?.itemQty,
  ...
  Center emptyFavoriteWidget(){
    return Center(
      child: Padding(
        ...
        child: noDataFoundContainerCatalog("Your Cart is Empty"),
      ),
    );
  }
}
